...
public class DeleteDishDialog extends Dialog {
	 ...
	 * @param style
	 */
	public DeleteDishDialog(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents(TableItem[] item) {
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				DishManage.deleteDish(label.getText());
				getParent().redraw();
				shell.close();
			}
		});
