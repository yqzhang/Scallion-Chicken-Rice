...
public class InsertUserDialog extends Dialog {
	 ...
	 * @param style
	 */
	public InsertUserDialog(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		btnNewButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				UserManage.insertUser(textUserName.getText(), textPassword.getText(), comboUserType.getItem(comboUserType.getSelectionIndex()));
				getParent().redraw();
				shell.close();
			}
		});
